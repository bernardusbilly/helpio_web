Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :facebook, '807318016080580', '4edcce637943228fd4fdfa9e0ada0d8b', :info_fields => 'name,email,birthday,gender', :callback_url => 'http://localhost:3000/omniauth/facebook/callback'
end